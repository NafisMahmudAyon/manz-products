...
const NotFoundSVG = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" {...props}>
    ...
    <g fill="none" stroke="#fff" strokeMiterlimit={10} strokeWidth={3}>
    ...
    <g
      ...
      strokeWidth={3}
    >
      <path d="M518.07 245.375v21.206M508.129 255.978h19.881M154.55 231.391v21.207M144.609 241.995h19.881M320.135 132.746v21.206M310.194 143.349h19.881M200.67 483.11v21.206M210.611 493.713H190.73" />
    </g>
    <g
      fill="none"
      stroke="#fff"
      ...
      strokeWidth={3}
    >
      <path d="M432.173 380.52v11.31M426.871 386.175h10.603M489.555 299.765v8.359M485.636 303.945h7.837M231.468 291.009v8.36M227.55 295.189h7.837M244.032 547.539v8.359M247.95 551.719h-7.837M186.359 406.967v8.359M190.277 411.146h-7.837M480.296 406.967v8.359M484.215 411.146h-7.837" />
    </g>
    <g
      fill="none"
      stroke="#fff"
...
const NotFound = () => {
  return (
    <main className="w-[100vw] h-[100vh] flex items-center justify-center bg-[#0E2954] ">
      <div className="container flex justify-center items-center h-[100vh] ">
        <div className="row flex items-center sm:flex-col  sm:px-10 ">
