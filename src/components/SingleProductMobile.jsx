  ...
  return (
    <div className="flex w-[100%] justify-center">
      <div className=" px-24 sm:px-4 mt-24 flex  sm:flex-col max-w-[1024px] min-h-[300px] ">
        ...
        <div className="pl-7 pr-5 sm:px-5 py-5 w-1/2 sm:w-full  bg-sky-200 grid grid-cols-1 h-[100%] content-between rounded-r-lg sm:rounded-bl-lg sm:rounded-br-lg sm:rounded-r-none">
